    ...
    >
      <div>
        <div className="flex flex-col gap-4">
          <p className="text-sm text-red-600 tracking-[4px]">Recent Experience</p>
        ...
        <div className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Key Skills</p>
            <p className="mt-2">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Continuous Learning</p>
            <p className="mt-2">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Collaborative Spirit</p>
            <p className="mt-2">
      ...
      <div>
        ...
        <div className="mt-14 w-full h-[1000px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Self-Taught Enthusiast</p>
            <p className="mt-2">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Versatile Developer</p>
            <p className="mt-2">
